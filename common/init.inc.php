...
include ROOT_DIR . "common/looeic.php";
...
include(ROOT_DIR . "component/index/model/indexmodel.php");
include(ROOT_DIR . "component/index/model/sessionsMember.php");

//$company_info['company_id']=1;
//$company_info['compnay_name']='daba';
$member = new sessionsMember();
