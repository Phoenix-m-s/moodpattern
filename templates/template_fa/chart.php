            ...
            <div class="row">
                ...
                <?php if($list['list']['topic']['topic_type']==1 || $list['list']['topic']['topic_type']==3 || $list['list']['topic']['topic_type']==4 || $list['list']['topic']['topic_type']==5 || $list['list']['topic']['topic_type']==6){ ?>
                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header text-right bg-info text-white ">
                                <h5 class="text-white"> <i class="fa fa-edit"></i> توانایی حسی</h5>
                            </div>
                            <?php
                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header text-right bg-info text-white ">
                                <h5 class="text-white"> <i class="fa fa-edit"></i> سود حسی   </h5>
                            </div>
                            <?php
                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            <div class="card-header text-right bg-info text-white ">
                                <h5 class="text-white"> <i class="fa fa-edit"></i> انرژی حسی </h5>
                            </div>
                            <?php
