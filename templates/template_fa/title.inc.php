...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta name="description" content="Your Mood Pattern, تحلیل آنچه که می‌توانم و آنچه که نمی‌توانم">
    ...
    <!-- Jquery-->
    <script src="<?php echo RELA_DIR . 'templates/' . CURRENT_SKIN; ?>/assets/js/highcharts.js"></script>

    <script src="<?php echo RELA_DIR . 'templates/' . CURRENT_SKIN; ?>/assets/js/highcharts-more.js"></script>


    <!--    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/jquery.rangerover.min.js"></script>
-->    <!-- Jquery-->
  <!--  <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/all.js"></script>

    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/brands.js"></script>
    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/conflict-detection.js"></script>
    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/fontawesome.js"></script>
    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/regular.js"></script>
    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/solid.js"></script>
    <script src="<?php /*echo RELA_DIR . 'templates/' . CURRENT_SKIN; */?>/assets/js/v4-shims.js"></script>-->
