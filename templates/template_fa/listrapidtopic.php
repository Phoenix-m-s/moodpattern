...
foreach($list['list'] as $k=>$v){
    $link1 = "<a class='mr-2' href='/rapidQuestion/?action=edit&id=".$v['id']."' title='ویرایش'> <i class='fa fa-edit'></i> </a>" ;
    $link2 = "<a class='mr-2' href='/chart/?topicId=".$v['id']."' title='مشاهده گراف'> <i class='fa fa-bar-chart'></i> </a>" ;
...
<main>
    <div id="form_container"  style="text-align: center;direction: rtl;height: auto;">
        ...
        <div class="row">
            <div class="col-md-12 mt-4">
                <a href="/rapidQuestion/?action=add" class="btn btn-primary" role="button"style="float: right;margin-right: 5px; background-color: #007bff;" >جدید</a>
            </div>
        </div>
        <!-- /row -->
        <div class="row">
