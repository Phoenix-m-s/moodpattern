...
!function (t, s, e, n) {
    ...
    var o = {
        ...
        useURLhash: !0,
        showStepURLhash: !0,
        lang: {previous: "مرحله قبل", next: "مرحله بعد" },
        toolbarSettings: {
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            var e = this, n = this.steps.eq(this.current_index), i = "", o = this.steps.eq(s), a = o.data("content-url") && o.data("content-url").length > 0 ? o.data("content-url") : this.options.contentURL;
            ...
            var e = this, n = this.steps.eq(this.current_index), i = n.length > 0 ? t(n.attr("href"), this.main) : null, o = this.steps.eq(s), a = o.length > 0 ? t(o.attr("href"), this.main) : null, r = "";
